...
public class YonghuController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(role == null || "".equals(role) ||"员工".equals(role)){
            return R.error(511,"您没有权限查用户列表");
            ...
            params.put("roleTypes1111",1);//总经理不能修改总经理的信息
        }
        //管理员能查看全部的人员
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", role_types.get(yonghu.getRoleTypes()));
        R r = R.ok();
        r.put("token", token);
        r.put("role",role_types.get(yonghu.getRoleTypes()));
