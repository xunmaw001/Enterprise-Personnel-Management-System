...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">奖惩管理</li>
                            <li class="breadcrumb-item active">奖惩列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jiangchengNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="奖惩名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        奖惩类型
                                        <div class="layui-input-inline">
                                            <select name="jiangchengTypesSelectSearch"  style="width: 150px;" id="jiangchengTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        权限
                                        <div class="layui-input-inline">
                                            <select name="roleTypesSelectSearch"  style="width: 150px;" id="roleTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //奖惩名称
            var jiangchengNameSearchInput = $('#jiangchengNameSearch');
            if( jiangchengNameSearchInput != null){
                if (jiangchengNameSearchInput.val() != null && jiangchengNameSearchInput.val() != '') {
                    searchForm.jiangchengName = $('#jiangchengNameSearch').val();
                }
            }
     
                //奖惩类型
            var jiangchengTypesSelectSearchInput = document.getElementById("jiangchengTypesSelectSearch");
            if(jiangchengTypesSelectSearchInput != null){
                var jiangchengTypesIndex = jiangchengTypesSelectSearchInput.selectedIndex;
                if( jiangchengTypesIndex  != 0){
                    searchForm.jiangchengTypes= document.getElementById("jiangchengTypesSelectSearch").options[jiangchengTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("jiangcheng/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                jiangchengName: searchForm.jiangchengName,
                jiangchengTypes: searchForm.jiangchengTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //奖惩名称
            var jiangchengNameCell = document.createElement('td');
            jiangchengNameCell.innerHTML = item.jiangchengName;
            row.appendChild(jiangchengNameCell);


            //奖惩类型
            var jiangchengTypesCell = document.createElement('td');
            jiangchengTypesCell.innerHTML = item.jiangchengValue;
            row.appendChild(jiangchengTypesCell);


                //奖惩详情
            var jiangchengContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.jiangchengContent && item.jiangchengContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.jiangchengContent.indexOf('<img');
                var endIndex = item.jiangchengContent.indexOf('>');
                    jiangchengContentCell.innerHTML = item.jiangchengContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.jiangchengContent != null && item.jiangchengContent != "" && item.jiangchengContent.length >= 11) {
                        jiangchengContentCell.innerHTML = item.jiangchengContent.substring(0, 10) + "...";
                } else {
                        jiangchengContentCell.innerHTML = item.jiangchengContent;
                }
            }
            row.appendChild(jiangchengContentCell);
            ...
            //主管 不能修改和删除自己的
            if (window.sessionStorage.getItem('role') == "部门主管" && window.sessionStorage.getItem('userId') != item.yonghuId) {
                debugger
                //修改按钮
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiangcheng", "addjiangcheng");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
            ...
            function jiangchengTypesSelectSearch() {
                var jiangchengTypesSelectSearch = document.getElementById('jiangchengTypesSelectSearch');
                if(jiangchengTypesSelectSearch != null) {
                    jiangchengTypesSelectSearch.add(new Option('-请选择-',''));
                    if (jiangchengTypesOptions != null && jiangchengTypesOptions.length > 0){
                        for (var i = 0; i < jiangchengTypesOptions.length; i++) {
                                jiangchengTypesSelectSearch.add(new Option(jiangchengTypesOptions[i].indexName,jiangchengTypesOptions[i].codeIndex));
                        }
                    }
                }
            }
    ...
    //查询当前表搜索条件所有列表
            function jiangchengTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiangcheng_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        jiangchengTypesOptions = res.data.list;
                    }
                });
            }
