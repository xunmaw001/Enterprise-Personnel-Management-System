            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">培训列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">培训列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                 
                                        <label>
                                            培训开始时间
                                            <input type="date" id="onTimeStartSearch" class="form-control " placeholder="开始" aria-controls="tableId">
                                        </label>
                                            -
                                        <label>
                                            <input type="date" id="onTimeEndSearch" class="form-control" placeholder="结束" aria-controls="tableId">
                                        </label>
                                 
                                        <label>
                                            培训结束时间
                                            <input type="date" id="downTimeStartSearch" class="form-control " placeholder="开始" aria-controls="tableId">
                                        </label>
                                            -
                                        <label>
                                            <input type="date" id="downTimeEndSearch" class="form-control" placeholder="结束" aria-controls="tableId">
                                        </label>
                                 
                                            <label>
                                                培训天数
                                                <input type="text" id="dayNumberStartSearch" onchange="dayNumberChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                            </label>
                                                -
                                            <label>
                                                <input type="text" id="dayNumberEndSearch" onchange="dayNumberChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                            </label>
...
<script>
    ...
    <!-- 本表的查询条件 -->
        ...
        if( downTimeEndSearch != null){
            ...
            //培训天数
        var dayNumberStartSearchInput = $('#dayNumberStartSearch');
        if(dayNumberStartSearchInput != null){
            var dayNumberStartSearchValue = dayNumberStartSearchInput.val();
            if( dayNumberStartSearchValue  != 0){
                searchForm.dayNumberStart = dayNumberStartSearchValue;
            }
        }
        var dayNumberEndSearchInput = $('#dayNumberEndSearch');
        if(dayNumberEndSearchInput != null){
            var dayNumberEndSearchValue = dayNumberEndSearchInput.val();
            if( dayNumberEndSearchValue  != 0){
                searchForm.dayNumberEnd = dayNumberEndSearchValue;
            }
        }
                getDataList();
    }
    ...
    function getDataList() {
        http("cultivate/page", "GET", {
            ...
            dayNumberStart: searchForm.dayNumberStart,
            dayNumberStart: searchForm.dayNumberStart,
    ...
    function setDataRow(item, number) {
        ...
        //培训天数
        var dayNumberCell = document.createElement('td');
        dayNumberCell.innerHTML = item.dayNumber;
        row.appendChild(dayNumberCell);


        //培训内容
        var cultivateContentCell = document.createElement('td');
        cultivateContentCell.innerHTML = item.cultivateContent;
        row.appendChild(cultivateContentCell);
        ...
        // 整数
        function dayNumberChickValue(e){
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("cultivate/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addcultivate", "addcultivate");
        window.location.href = "add-or-update.jsp"
    }
