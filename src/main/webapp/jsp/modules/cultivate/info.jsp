            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">培训登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>培训开始时间</label>
                                        <input id="onTime" name="onTime" class="form-control"
                                               v-model="ruleForm.onTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>培训结束时间</label>
                                        <input id="downTime" name="downTime" class="form-control"
                                               v-model="ruleForm.downTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>培训天数</label>
                                        <input id="dayNumber" name="dayNumber" class="form-control"
                                               v-model="ruleForm.dayNumber" readonly>
                                    </div>
        ...
        if (ruleForm.cultivateContent != null && ruleForm.cultivateContent != 'null' && ruleForm.cultivateContent != '') {
            ...
            var cultivateContentUeditor = UE.getEditor('cultivateContentEditor');
                cultivateContentUeditor.ready(function () {
                    ...
                    cultivateContentUeditor.setDisabled('fullscreen');
            });
        }
    }
