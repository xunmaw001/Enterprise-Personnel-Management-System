            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">考勤登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="today" name="today" class="form-control"
                                               v-model="ruleForm.today" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>打卡类型</label>
                                    <input id="chuqinValue" name="chuqinValue" class="form-control"
                                           v-model="ruleForm.chuqinValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="overtimeNumber" name="overtimeNumber" class="form-control"
                                               v-model="ruleForm.overtimeNumber" readonly>
                                    </div>
